...
//! \brief Timer count for specific data rate delay, computed for 4Mhz SMCLK.
#define BAUD_115200_DELAY  0x000E//Slightly low to account for the set-up cycles that we delayed. At these times that's necessary...
//! \def BAUD_57600_DELAY
//! \brief Timer 0count for specific data rate delay, computed for 4Mhz SMCLK.
#define BAUD_57600_DELAY   0x0037
//! \def BAUD_19200_DELAY
//! \brief Timer count for specific data rate delay, computed for 4Mhz SMCLK.
#define BAUD_19200_DELAY   0x0068
//! \def BAUD_9600_DELAY
//! \brief Timer count for specific data rate delay, computed for 4Mhz SMCLK.
#define BAUD_9600_DELAY    0x00A3
//! \def BAUD_9600_DELAY
//! \brief Timer count for specific data rate delay, computed for 4Mhz SMCLK.
